/**
 * 默认预置的用户API音源
 * 来源: https://github.com/pdone/lx-music-source
 */

export const DEFAULT_USER_API_SCRIPT = `/*!
 * @name 微信公众号：洛雪音乐
...
const rHash = (s) => {
  checksum = 0
  for (let b of s.split('')) checksum = (checksum * 114 + b.charCodeAt()) & 0x7FFFFFFF
  return checksum
}
